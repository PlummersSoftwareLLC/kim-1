...
INIT:	CLD					; CLEAR DECIMAL
		...
		STA		VMORG
		LDA 	#DISPCH&$FF ; SET USRLOC TO GO TO GRAPHICS DISPATCH					
		STA		$2040		
		LDA 	#DISPCH/256 ; 
		STA		$2041
;		
...
CLEAR	LDY 	#0 			; INITIALIZE ADDRESS POINTER
		...
		LDA 	VMORG
		STA 	ADP2+1
		LDA 	#NPIX/8/256 ; SET COUNT OF BYTES TO CLEAR
		STA 	DCNT1+1
		LDA 	#NPIX/8&$FF
		STA 	DCNT1
...
SDTX40 	LDA 	#0 			; SET UP ADDRESS POINTERS FOR MOVE
		...
		LDA 	#CHHI*40&$FF
		STA 	ADP1
		LDA 	#NSCRL&$FF 	; SET NUMBER OF LOCATIONS TO MOVE
		STA 	DCNT1 		; LOW PART
		...
		LDA 	#NLIN-1*CHHI*40&$FF ; SET ADDRESS POINTER
		STA 	ADP2 		; LOW BYTE
		LDA 	#NLIN-1*CHHI*40/256	
		CLC
		ADC 	VMORG
		STA 	ADP2+1 		; HIGH BYTE
		LDA 	#NCLR&$FF  	; SET LOW BYTE OF CLEAR COUNT
		STA DCNT1
