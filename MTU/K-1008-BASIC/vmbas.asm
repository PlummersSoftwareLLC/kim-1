...
VMORG:          .res 1			; FIRST PAGE NUMBER OF VISIBLE MEMORY
CSRX:           .res 1	        	; TEXT CURSOR CHARACTER NUMBER
CSRY:           .res 1  		; TEXT CURSOR LINE NUMBER
...
X1CORD:         .res 2   		; COPY OF BASIC'S X1 COORDINATE
Y1CORD:         .res 2		        ; COPY OF BASIC'S Y1 COORDINATE
X2CORD:         .res 2 		        ; COPY OF BASIC'S X2 COORDINATE
Y2CORD:         .res 2	        	; COPY OF BASIC'S Y2 COORDINATE
TEMP:           .res 2  		; TEMPORARY STORAGE
BTPT:           .res 1	        	; BIT POINTER WITHIN BYTE
SAVE:           .res 1  		; DO NOT USE KIM'S SAVE BYTE!!!!
ADP1:           .res 2  		; ADDRESS POINTER 1
ADP2:           .res 2  		; ADDRESS POINTER 2
DELTAX:         .res 2		        ; DELTA X FOR LINE DRAW
DELTAY:         .res 2		        ; DELTA Y FOR LINE DRAW
ACC:            .res 2	        	; ACCUMULATOR FOR LINE DRAW
XDIR:           .res 1			; X MOVEMENT DIRECTION, ZERO=+
YDIR:           .res 1		        ; Y MOVEMENT DIRECTION, ZERO=+	
XCHFLG:         .res 1	        	; EXCHANGE X AND Y FLAG, EXCAHNE IF NOT 0
COLOR:          .res 1  		; COLOR OF LINE DRAW - 1 =M WHITE
